...
psych::cor.plot(bluesqs, numbers = TRUE, main="correlations between items",
...
omega.ati <- MBESS::ci.reliability(data = ati.data, type = "omega", conf.level = 0.95,
                                   interval.type = "perc", B = 100)
omega.ati
#omega with CI for ATI8
omega.ati8 <- ci.reliability(data = ati.data8, type = "omega", conf.level = 0.95,
                            interval.type = "perc", B = 100)
omega.ati8
